@testset "parse_atom_items (live Atom feed)" begin
    doc = FytcMCP_arXiv.fetch_atom_feed("hep-ph")
    all_papers = FytcMCP_arXiv.parse_atom_items(doc)
    ...
    @testset "announce_type filtering works" begin
        ...
        for t in types
            filtered = FytcMCP_arXiv.parse_atom_items(doc; announce_type=t)
    ...
    @testset "non-existent announce_type returns empty" begin
        @test isempty(FytcMCP_arXiv.parse_atom_items(doc; announce_type="nonexistent"))
    end
